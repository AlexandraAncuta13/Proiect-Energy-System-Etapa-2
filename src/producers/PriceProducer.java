...
public final class PriceProducer implements ProducerStrategy {

    private DistributorsInputData distributorsInputData;
    private List<ProducersInputData> producersInputData;

    public PriceProducer(DistributorsInputData distributorsInputData,
    ...
    public void getProducers() {
        int energy = 0;
        producersInputData.sort(new SortByPrice());
