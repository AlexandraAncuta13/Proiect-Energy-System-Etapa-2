...
public final class GreenProducer implements ProducerStrategy {
    private DistributorsInputData distributorsInputData;
    private List<ProducersInputData> producersInputData;

    public GreenProducer(DistributorsInputData distributorsInputData,
    ...
    public void getProducers() {
        int energy = 0;
        producersInputData.sort(new SortByEnergyType());
